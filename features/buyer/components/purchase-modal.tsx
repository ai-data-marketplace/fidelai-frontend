      ...
      <AnimatePresence mode="wait">
        ...
        >
          ...
          <div className="flex items-start gap-3 p-2">
            ...
            >
              I agree to the <strong>License Agreement</strong> and{" "}
              <strong>Data Usage Policy</strong>.
            </label>
          </div>
          ...
          <div className="flex items-center justify-end gap-3 pt-2">
            ...
            <Button
              ...
              disabled={
                isProcessing || !agreedToTerms || purchaseDataset.isPending
              }
              onClick={handlePurchase}
            >
              {isProcessing || purchaseDataset.isPending
                ? "Processing..."
                : `Pay with Chapa`}
            </Button>
          </div>
